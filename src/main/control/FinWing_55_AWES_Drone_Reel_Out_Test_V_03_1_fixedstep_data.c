 ...
 *
 * File: FinWing_55_AWES_Drone_Reel_Out_Test_V_03_1_fixedstep_data.c
 *
...
const ConstB_FinWing_55_AWES_Drone__T FinWing_55_AWES_Drone_Re_ConstB = {
  { 0.0, 0.0, 14.709975 },             /* '<S1>/Gain' */
  0.503245,                            /* '<S2>/Gain1' */
  32.07703896588                       /* '<S8>/ThrustX' */
};

/* Constant parameters (default storage) */
const ConstP_FinWing_55_AWES_Drone__T FinWing_55_AWES_Drone_Re_ConstP = {
